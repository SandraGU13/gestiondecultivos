...
function ModalAgregarSemilla() {
    ...
    <form onSubmit={enviar}>
        <div className="modal fade" id="agregarSemillaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="text-gray-800" id="exampleModalLabel">Agregar semilla</h5>
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" name={"nombre"} placeholder="">
                                        {/*<!--<small id="emailHelp" className="form-text text-muted">We'll never share your email with anyone else.</small>-->*/}</input>
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="form-group">
