...
function ModalAgregarCultivos(){
  return (
    <div class="modal fade" id="agregarCultivoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="text-gray-800" id="exampleModalLabel">Agregar cultivo</h5>
            ...
            <div class="modal-footer">
                <a class="btn btn-primary" href="cultivos.html">Agregar</a>
