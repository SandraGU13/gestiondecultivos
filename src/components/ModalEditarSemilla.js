...
function ModalEditarSemilla() {
    ...
    return (
        <form onSubmit={enviar}>
            <div className="modal fade" id="editarSemillaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="text-gray-800" id="exampleModalLabel">Editar semilla</h5>
