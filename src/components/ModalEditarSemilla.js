...
function ModalEditarSemilla() {
  return (
    <div class="modal fade" id="editarSemillaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="text-gray-800" id="exampleModalLabel">Editar semilla</h5>
                ...
                <div class="modal-footer">
                    <Link class="btn btn-warning" to="predios.html">Editar</Link>
