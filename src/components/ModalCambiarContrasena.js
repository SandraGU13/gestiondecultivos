...
function ModalCambiarContrasena() {
  return (
    <div className="modal fade" id="cambiarcontraseña" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div className="modal-content">
            ...
            <div className="modal-footer">
                <Link className="btn btn-primary" to="/usuarios">Cambiar</Link>
